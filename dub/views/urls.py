...
from dub.views.user_view import UserCreateResource, UserGetResource, UserCheckPasswordResource, UserSaveResource, UserDeleteResource
...
api.add_resource(UserDeleteResource, "/user/delete/", endpoint="user_delete")
